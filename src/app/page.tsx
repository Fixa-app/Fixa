        ...
        <div className="px-4">
          <div className="mx-auto grid w-full max-w-[1920px] gap-4 md:grid-cols-3">
            {aiCards.map(({ title, body, Mockup }) => (
              <article
                key={title}
                className="flex flex-col gap-6 rounded-3xl bg-[#E2DFD4] p-6 md:p-8"
              >
...
function SiteFooter() {
  return (
    <footer className="px-4 pb-4">
      <div className="relative mx-auto w-full max-w-[1920px] overflow-hidden rounded-3xl bg-primary-dark text-white">
